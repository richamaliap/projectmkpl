...
echo form_dropdown('TipeBarang', $TipeBarang, set_value('TipeBarang', $data['TipeBarang']),'required');
echo "</td>";
echo "</tr>";
...
echo "</td>";
echo "<td>";
echo form_input('SerialNumber', set_value('SerialNumber', $data['SerialNumber']),'required');
echo "</td>";
echo "</tr>";
...
echo "</td>";
echo "<td>";
echo form_input('NamaBarang', set_value('NamaBarang', $data['NamaBarang']),'required');
echo "</td>";
echo "</tr>";
